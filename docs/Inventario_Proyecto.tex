...
\begin{itemize}
  \item \textbf{GitHub} --- \url{https://github.com/Palermo01/UrbanFlow_CDMX}
  \item \textbf{Google Colab} --- ejecución del notebook reproducible
  \item \textbf{Streamlit Community Cloud / ngrok} --- opciones de demo pública (por confirmar)
\end{itemize}
...
\begin{enumerate}
  ...
  \item Código fuente completo en \url{https://github.com/Palermo01/UrbanFlow_CDMX}
\end{enumerate}
